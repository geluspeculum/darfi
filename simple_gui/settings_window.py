...
class SettingsWindow(QtWidgets.QDialog):
    ...
    def __init__(self,settings):
        ...
        sensitivityLabel = QtWidgets.QLabel(self)
        sensitivityLabel.setText("Sensitivity:")
        self.sensitivityField = QtWidgets.QDoubleSpinBox()
        ...
        sensitivityLabel.setSizePolicy(QtWidgets.QSizePolicy.Minimum,QtWidgets.QSizePolicy.Minimum)
        self.sensitivityField.setSizePolicy(QtWidgets.QSizePolicy.Minimum,QtWidgets.QSizePolicy.Minimum)
        tab1layout.addWidget(sensitivityLabel,0,0)
        tab1layout.addWidget(self.sensitivityField,0,1)
        

        min_cell_sizeLabel = QtWidgets.QLabel(self)
        min_cell_sizeLabel.setText("Minimal cell size:")
        self.min_cell_sizeField = QtWidgets.QDoubleSpinBox()
        ...
        min_cell_sizeLabel.setSizePolicy(QtWidgets.QSizePolicy.Minimum,QtWidgets.QSizePolicy.Minimum)
        self.min_cell_sizeField.setSizePolicy(QtWidgets.QSizePolicy.Minimum,QtWidgets.QSizePolicy.Minimum)
        tab1layout.addWidget(min_cell_sizeLabel,1,0)
        tab1layout.addWidget(self.min_cell_sizeField,1,1)
        
        spacer1=QtWidgets.QSpacerItem(0, 0, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding) 
        ...
        foci_lookup_sensivityLabel = QtWidgets.QLabel(self)
        foci_lookup_sensivityLabel.setText("Foci lookup sensitivity")
        self.foci_lookup_sensivityField = QtWidgets.QDoubleSpinBox()
        ...
        foci_min_val_percLabel = QtWidgets.QLabel(self)
        foci_min_val_percLabel.setText("Foci area fill percent")
        self.foci_area_fill_percentField = QtWidgets.QDoubleSpinBox()
        ...
        min_foci_radiusLabel = QtWidgets.QLabel(self)
        min_foci_radiusLabel.setText("Min foci radius")
        self.min_foci_radiusField = QtWidgets.QDoubleSpinBox()
        ...
        max_foci_radiusLabel = QtWidgets.QLabel(self)
        max_foci_radiusLabel.setText("Max foci radius")
        self.max_foci_radiusField = QtWidgets.QDoubleSpinBox()
        ...
        allowed_foci_overlapLabel = QtWidgets.QLabel(self)
        allowed_foci_overlapLabel.setText("Allowed foci overlap")
        self.allowed_foci_overlapField = QtWidgets.QDoubleSpinBox()
        ...
        self.set_auto_rescale_box = QtWidgets.QCheckBox('Auto rescale Foci', self)
        ...
        foci_rescale_minLabel = QtWidgets.QLabel(self)
        foci_rescale_minLabel.setText("Foci rescale min:")
        self.foci_rescale_minField = QtWidgets.QDoubleSpinBox()
        ...
        foci_rescale_maxLabel = QtWidgets.QLabel(self)
        foci_rescale_maxLabel.setText("Foci rescale max:")
        self.foci_rescale_maxField = QtWidgets.QDoubleSpinBox()
        ...
        self.normalize_intensity_box = QtWidgets.QCheckBox('Normalize intensity', self)
        ...
        spacer2=QtWidgets.QSpacerItem(0, 0, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding) 
        ...
        nuclei_colorLabel = QtWidgets.QLabel(self)
        ...
        foci_colorLabel = QtWidgets.QLabel(self)
        ...
        self.return_circles_box = QtWidgets.QCheckBox('Draw foci with circles', self)
        self.return_circles_box.setChecked(self.settings.return_circles)

        tab3layout.addWidget(self.return_circles_box,2,0)

        spacer3=QtWidgets.QSpacerItem(0, 0, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)         
        tab3layout.addItem(spacer3,3,0)
        
        tab4layout = QtWidgets.QVBoxLayout()
        self.tableWidget=TableWidget(self)
        tab4layout.addWidget(self.tableWidget)
        
        
        spacer4=QtWidgets.QSpacerItem(0, 0, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding) 
